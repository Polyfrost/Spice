...
class KeyboardImpl {
    ...
    fun areRepeatEventsEnabled(): Boolean = repeatEventsEnabled
    fun enableRepeatEvents(enable: Boolean) { repeatEventsEnabled = enable }

    fun getKeyName(key: Int): String = keyNames[key]!!
    ...
    fun getNumKeyboardEvents(): Int = queue.size
    ...
    fun isKeyDown(key: Int): Boolean = keyboardStates[key]!!
    ...
    private fun debugPendingEvents(): String = "Pending Keyboard Events: ${queue.size}"
